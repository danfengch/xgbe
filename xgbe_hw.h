...
struct e1000_rx_desc {
	__le32 buffer_addr_low;	    /* Address of the descriptor's data buffer */
    __le32 buffer_addr_high;	/* Address of the descriptor's data buffer */    
	__le32 num_words;		    /* Length of data DMAed into data buffer */
	__le32 resv;		        /* Packet checksum */
};
